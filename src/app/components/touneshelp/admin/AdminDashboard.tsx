...
export function AdminDashboard() {
  ...
  const statusData = useMemo(() => {
    ...
    return [
      ...
      {
        name: "En cours (Helping Now)",
        value: stats.overview.helpingCases,
        color: STATUS_COLORS.helping
      },
      {
        name: "Non résolus (Unsolved)",
        value: stats.overview.sufferingCases,
        color: STATUS_COLORS.suffering
      }
    ];
  }, [stats]);
  ...
  const recentTimingData = useMemo(() => {
    ...
    return Object.entries(dates)
      ...
      .slice(0, 7); // last 7 distinct dates
  }, [stats]);
        ...
        <Card className="p-6 border-l-4 border-[#C0392B]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-[#C0392B] mt-1">Nécessite de l'aide</p>
            </div>
        ...
        <Card className="p-6 border-l-4 border-[#F39C12]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-[#F39C12] mt-1">Aide en route</p>
            </div>
            <div className="relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <Card className="p-6">
          <h3 className="text-xl font-bold text-[#1C1C1E] mb-2">
            Répartition des statuts de cas
          </h3>
          <p className="text-sm text-gray-600 mb-6">
            Proportion des cas résolus, non résolus et en cours
          </p>
        ...
        <Card className="p-6">
          <h3 className="text-xl font-bold text-[#1C1C1E] mb-2">
            Timing des cas récents
          </h3>
          <p className="text-sm text-gray-600 mb-6">
            Évolution des signalements sur les derniers jours
          </p>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
          ...
          {[
            {
              type: "approved",
              text: "Cas approuvé",
              case: "Famille sans eau potable à Kasserine",
              time: "il y a 2h",
              color: "bg-green-500"
            },
            {
              type: "new",
              text: "Nouveau cas soumis",
              case: "École sans chauffage à Jendouba",
              time: "il y a 3h",
              color: "bg-blue-500"
            },
            {
              type: "resolved",
              text: "Cas résolu",
              case: "Personne âgée isolée à Gafsa",
              time: "il y a 5h",
              color: "bg-[#27AE60]"
            },
            {
