...
export function LanguageTranslator() {
  ...
  const [currentLang, setCurrentLang] = useState<Language>(
    languages.find((l) => l.code === (i18n.language as "fr" | "ar" | "en")) ||
      languages[0]
  );
  ...
  useEffect(() => {
    ...
    const lang = languages.find(
      (l) => l.code === (i18n.language as "fr" | "ar" | "en")
    );
    if (lang) {
      setCurrentLang(lang);
    }
            ...
            {languages.map((lang) => (
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <div
                    className={`font-medium ${currentLang.code === lang.code ? "text-[#C0392B]" : "text-gray-800"}`}
                  >
                    {lang.nativeName}
                  </div>
          ...
          <div className="absolute top-full right-0 mt-2 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden z-50">
            {languages.map((lang) => (
              ...
              >
                ...
                <span
                  className={`text-sm ${currentLang.code === lang.code ? "text-[#C0392B] font-medium" : "text-gray-700"}`}
                >
                  {lang.nativeName}
                </span>
              </button>
